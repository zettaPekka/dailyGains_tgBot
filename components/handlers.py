...
async def info(message: Message):
    await message.answer('<b>Этот бот помогает отслеживать твой прогресс каждый день.\n\nКак это работает: \n• <i>Добавить</i>: Нажми кнопку "Добавить", чтобы записать, в чем ты стал лучше сегодня. \n• <i>Редактировать</i>: Если хочешь изменить сегодняшнюю запись, нажми "Редактировать". \n• <i>Статистика</i>: Здесь можно посмотреть историю своего прогресса. Листай страницы — на каждой отображается по 15 дней. \n• <i>Полная статистика</i>: Напиши @zettapekka, и ты получишь файл со всеми своими записями.\n\nПросто и удобно! Начни улучшать себя уже сегодня. 🚀</b>')
